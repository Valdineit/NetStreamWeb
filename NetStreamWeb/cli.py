...
def main():
    ...
    try:
        subtitles = get_subtitles(audios, output_srt or srt_only, output_dir, lambda audio_path: model.transcribe(audio_path, **args))
    except Exception as e:
...
def get_subtitles(audio_paths: dict, output_srt: bool, output_dir: str, transcribe: callable):
    ...
    for path, audio_path in audio_paths.items():
        ...
        try:
            ...
            print(f"Error generating subtitles for {path}: {e}")
